                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Choose Class&Subject</h3>
                                </div>
                                <div class="panel-body">
                                    <form method="POST" action="{{ route('questions.handleSetup') }}">
                                        @csrf

                                        {{-- Row for Class and Subject --}}
                                        <div class="form-group row">
                                            {{-- Choose Class --}}
                                            <div class="col-md-6">
                                                <label for="classroom_id">Choose Class</label>
                                            ...
                                            {{-- Choose Subject (Only for Admins) --}}
