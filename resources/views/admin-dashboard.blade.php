                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="panel panel-primary text-center">
                                ...
                                <div class="panel-body">
                                    <h3 class="" id="authorCount"><b>{{ $totalUsers }}</b></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="panel panel-primary text-center">
                                ...
                                <div class="panel-body">
                                    <h3 class="" id="subjectCount"><b>{{ $totalSubjects }}</b></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="panel panel-primary text-center">
                                ...
                                <div class="panel-body">
                                    <h3 class="" id="classCount"><b>{{ $totalClasses }}</b></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="panel panel-primary text-center">
                                ...
                                <div class="panel-body">
                                    <h3 class="" id="questionCount"><b>{{ $totalAdminQuestions }}</b></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('show-question', ['user_id' => $user->id]) }}">View</a>
                                                    </td>
