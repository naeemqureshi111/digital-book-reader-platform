...
<div class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Instruction Management</h4>
            ...
            <div class="col-sm-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Edit Instruction</h3>
                    </div>
    ...
    @endif
        ...
        <div class="form-group">
            ...
            <select name="subject_id" class="form-control" required>
                @foreach($subjects as $subject)
                    <option value="{{ $subject->id }}" {{ $instruction->subject_id == $subject->id ? 'selected' : '' }}>
                        {{ $subject->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select name="class_id" class="form-control" required>
                @foreach($classes as $class)
                    <option value="{{ $class->id }}" {{ $instruction->class_id == $class->id ? 'selected' : '' }}>
                        {{ $class->name }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <textarea name="content" rows="8" class="form-control" required>{{ $instruction->content }}</textarea>
        </div>

        <!-- Submit -->
        <div class="form-group text-right">
            <button type="submit" class="btn btn-success">Update Instruction</button>
            <a href="{{ route('instructions.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
