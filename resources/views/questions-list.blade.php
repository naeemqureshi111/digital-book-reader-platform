            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="ti-book"></i> <span>Show
                                    Questions
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">Show Questions</h4>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h2>Questions for   Class: {{ $classroom->name }}, Subject: {{ $subject->name }},Chapter: {{ $chapter->name }},</h2>
                                </div>
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody>
                                            @foreach ($questions as $question)
                                                <tr>
                                                    <td>
                                                        @if (!empty($question->image_photo_url) && $question->image_photo_url !== 'default.jpg')
                                                            <a href="{{ asset($question->image_photo_url) }}"
                                                                target="_blank">
                                                                <img src="{{ asset($question->image_photo_url) }}"
                                                                    alt="Image"
                                                                    style="width: 60px; height: auto; border-radius: 4px; border: 1px solid #ccc;" />
                                                            </a>
                                                        @else
                                                            <span>No image</span>
                                                        @endif
