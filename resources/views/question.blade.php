...
<body class="fixed-left">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    @if (session('classroom_id') && session('subject_id') && session('chapter_id'))
                                        <form method="POST" action="{{ route('questions.store') }}"
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="file" class="form-control" name="image"
                                                        accept="image/*">
                                                        <small class="text-muted">Max size: 1MB, max width: 280px, max height:
                                                    245px</small>
                                                    <span class="error1" id="image-error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <span class="error2" id="name-error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <span class="error3" id="a-error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <span class="error4" id="b-error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <span class="error5" id="c-error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <span class="error6" id="d-error"></span>
                                                </div>
                                            </div>
    ...
    <div class="col-md-10">
        ...
        <span class="error7" id="correct-error"></span>
    </div>
</div>
                                    ...
                                    @else
                                        <p>Please <a href="{{ route('questions.setup') }}">select class and subject
                                                first</a>.</p>
                                        <a href="{{ route('chapter') }}">choose chapter</a> first.</p>
                                    @endif
