        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Instruction</h4>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="mb-3">
                            <h2 class="mb-4">All Instructions</h2>
                        ...
                        <table id="datatable-responsive"
                            ...
                            <tbody>
                                @forelse($instructions as $instruction)
                                    <tr>
                                        <td>{{ $instruction->subject->name ?? 'N/A' }}</td>
                                        <td>{{ $instruction->class->name ?? 'N/A' }}</td>
                                        <td>{!! Str::limit($instruction->content, 30) !!}</td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">No instructions found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
