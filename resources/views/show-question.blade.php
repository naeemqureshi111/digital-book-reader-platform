                                        ...
                                        <tbody>
                                            @foreach ($counts as $count)
                                                <tr>
                                                    ...
                                                    <td>{{ $chapters->firstWhere('id', $count->chapter_id)->name ?? 'N/A' }}
                                                    </td>
                                                    <td>
                                                        {{ $count->total }}
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('questions.byClassSubjectChapter', ['classroom' => $count->classroom_id, 'subject' => $count->subject_id,  'chapter' => $count->chapter_id]) }}?user_id={{ $user_id ?? '' }}">
                                                            View
                                                        </a>
                                                    </td>
                                                </tr>
