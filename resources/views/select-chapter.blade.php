                        ...
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h4 class="pull-left page-title">
                                    @if ($chapters->isEmpty())
                                        <div class="alert alert-warning">No chapters found for selected class and
                                            subject.</div>
                                    @endif
                                </h4>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Choose Subject</h3>
                                </div>
                                <div class="panel-body">
                                    <form method="POST" action="{{ route('questions.storeChapterSession') }}">
                                        @csrf

                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <label for="chapter_id">Choose Chapter</label>
